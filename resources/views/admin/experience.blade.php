...
@section('title', 'Experience Information')
@section('content')
@include('admin.navbar')
<section class="home-section">
  <div class="text">Experience</div>
  <a href="{{ route('experience.create') }}"><button class="button">
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td><img src="{{ asset( $experience->image )}}" style="width: 50px; height: 50px;" alt="Img" /></td>
        <td>
          <a href="{{ url('/experience/'.$experience->id.'/edit') }}"><button class="action">Edit</button></a>
          <button class="action delete-btn" data-url="{{ url('/experience/'.$experience->id.'/delete') }}">Delete</button>
        </td>
      </tr>
      @endforeach
    </tbody>
